...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.lineEdit_Login.setGeometry(QtCore.QRect(80, 10, 411, 30))
        self.lineEdit_Login.setObjectName("lineEdit_Login")
        self.lineEdit_Password = QtWidgets.QLineEdit(self.centralwidget)
        self.lineEdit_Password.setGeometry(QtCore.QRect(80, 50, 411, 30))
        ...
        self.label_Login.setGeometry(QtCore.QRect(40, 20, 31, 16))
        ...
        self.label_Password.setGeometry(QtCore.QRect(20, 60, 57, 16))
